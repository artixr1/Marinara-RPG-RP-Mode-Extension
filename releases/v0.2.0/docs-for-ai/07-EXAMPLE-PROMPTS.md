...
- releases/v0.2.0/docs-for-ai/01-OVERVIEW.md through 07-EXAMPLE-PROMPTS.md (read all seven in order)

Two complete worked examples are in:
- releases/v0.2.0/examples/exalted3e/ (a complex system with typed damage, multi-turn sorcery casting, and per-system agent overrides)
- releases/v0.2.0/examples/dnd5e/ (a simpler single-roll system that mostly inherits the shared agent baselines)
...
- The seven `.md` files in `releases/v0.2.0/docs-for-ai/`
