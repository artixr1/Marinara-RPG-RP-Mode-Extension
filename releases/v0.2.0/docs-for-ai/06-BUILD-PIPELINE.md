...
If your target system's dice math doesn't fit any of the five existing modes (single-roll / dice-pool / d100-percentile / 2d6-stat / fate-ladder), you're extending the framework, not just adding data files.
